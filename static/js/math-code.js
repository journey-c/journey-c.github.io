...
Even.mobileNavbar = function () {
    ...
    const slideout = new Slideout({'panel': document.getElementById('mobile-panel'), 'menu': document.getElementById('mobile-menu'), 'padding': 180, 'tolerance': 70, });
...
Even._initToc = function () {
    ...
    if ($toc.length) {
        ...
        const tocState = {start: {'position': 'absolute', 'top': minScrollTop, }, process: {'position': 'fixed', 'top': SPACING, }, end: {'position': 'absolute', 'top': maxScrollTop, }, };
        $(window).scroll(function () {
...
Even.fancybox = function () {
    if ($.fancybox) {
        ...
        $('.fancybox').fancybox({selector: '.fancybox', protect: true, });
    }
};
...
Even.flowchart = function () {
    ...
    for (let i = 0;
        ...
        const block = blocks[i];
        const rootElement = window.hljs ? block.parentElement : block.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement;
